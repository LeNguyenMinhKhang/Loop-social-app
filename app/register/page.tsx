    ...
    <>
      ...
      <main className="min-h-screen flex flex-col bg-[#0a0a1a] relative overflow-hidden">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-purple-500 rounded-full mix-blend-screen filter blur-[120px] opacity-[0.05] animate-blob-move" style={{ animationDelay: '3s' }} />
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
          <div className="w-full max-w-md">
            <div className="mb-8 text-center">
              ...
              <h1 className="text-3xl font-bold text-white">Join Loop</h1>

export function ChangeEmailForm() {
  return (
    <div className="bg-[#12122a]/80 backdrop-blur-xl rounded-2xl border border-violet-500/10 p-6 mb-4">
      <h4 className="text-lg font-bold text-white mb-4">Change Email</h4>
      <form className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-2">Current Email</label>
          <input type="email" className="w-full bg-[#0a0a1a]/80 border border-violet-500/15 rounded-xl py-3 px-4 text-gray-500 focus:outline-none" defaultValue="user@example.com" disabled />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-2">New Email</label>
          <input type="email" className="w-full bg-[#0a0a1a]/80 border border-violet-500/15 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-violet-500/50 transition-colors" placeholder="new@example.com" />
        </div>
